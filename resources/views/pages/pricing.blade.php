...
<div id="navbar" class="sticky top-0 z-10 shadow-md slide-in ">  
    ...
    <section class="bg-gray-100 py-16">
        <div class="container mx-auto px-6 lg:px-20">
          <h2 class="text-4xl font-bold text-center text-gray-800 mb-12">Our Pricing</h2>
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Out Patients -->
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">Out Patients</h3>
              <p class="text-gray-600 mb-6">
                Affordable care for patients requiring outpatient services.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 50,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
            ...
            <!-- In Patients -->
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">In Patients</h3>
              <p class="text-gray-600 mb-6">
                Comprehensive care for patients admitted to our facility.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 200,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
            ...
            <!-- Forensic -->
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">Forensic</h3>
              <p class="text-gray-600 mb-6">
                Specialized forensic mental health services.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 300,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">Substance Rehabilitation</h3>
              <p class="text-gray-600 mb-6">
                Helping individuals recover from substance dependence.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 150,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">Psychosocial Services</h3>
              <p class="text-gray-600 mb-6">
                Support for mental and social well-being.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 100,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
            ...
            <!-- Occupation Therapy -->
            <div class="bg-white rounded-lg shadow-lg p-6 text-center">
              <h3 class="text-2xl font-semibold text-gray-800 mb-4">Occupation Therapy</h3>
              <p class="text-gray-600 mb-6">
                Therapy to support functional independence and recovery.
              </p>
              <p class="text-4xl font-bold text-blue-800 mb-6">MWK 120,000</p>
              <button class="bg-blue-800 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-blue-700">
                Apply Now
              </button>
            </div>
