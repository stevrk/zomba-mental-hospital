...
<div id="navbar" class="sticky top-0 z-10 shadow-md slide-in ">  
    ...
    <div class="bg-blue-700 text-white py-2 px-2 md:py-3 md:px-4 ">
        ...
        <nav class="bg-white text-blue-700 px-4 py-2">
            <div class="container mx-auto flex items-center justify-between lg:pr-[200px]"> <!-- Added 'pr-6' for padding on the right -->
            ...
            <div id="mobileMenu" class="hidden lg:hidden bg-white py-2">
              <ul class="space-y-2 px-4">
                <li><a href="{{ route('welcome') }}" class="block hover:underline">Home</a></li>
    ...
    <section id="contact-us" class="py-16 bg-blue-50">
        <div class="container mx-auto px-6 lg:px-12">
          ...
          <p class="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            We're here to help! Get in touch with us for any inquiries, assistance, or feedback. We look forward to hearing from you.
          </p>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
              ...
              <ul class="space-y-4 text-gray-600">
                <li>
                  ...
                  <strong>Phone:</strong> +265 123 456 789
                </li>
                <li>
                  <i class="fas fa-envelope text-blue-600 mr-2"></i>
                  <strong>Email:</strong> info@hospitalname.mw
                </li>
                <li>
                  <i class="fas fa-map-marker-alt text-blue-600 mr-2"></i>
                  <strong>Address:</strong> 123 Health Avenue, Lilongwe, Malawi
                </li>
                <li>
              ...
              <form action="#" method="POST" class="space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Enter your name" required>
                  </div>
                  <div>
                    <label for="email" class="block text-gray-600 font-medium">Your Email</label>
                    <input type="email" id="email" name="email" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Enter your email" required>
                  </div>
                </div>
                <div>
                  <label for="message" class="block text-gray-600 font-medium">Your Message</label>
                  <textarea id="message" name="message" rows="5" class="w-full border border-gray-300 rounded-lg px-4 py-2" placeholder="Write your message here..." required></textarea>
                </div>
                <button type="submit" class="w-full bg-blue-600 text-white font-semibold rounded-lg px-4 py-2 hover:bg-blue-700">
                  Send Message
                </button>
              </form>
            </div>
