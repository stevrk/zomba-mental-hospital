...
<div id="navbar" class="sticky top-0 z-10 shadow-md slide-in ">  
    ...
    <nav class=" bg-white text-blue-700 px-4 py-2 lg:pr-[200px]">
      ...
      <div class="relative bg-black">
        <!-- Image with opacity and black background -->
        <img src="{{ asset('images/staff.jpg') }}" alt="Background Image" class="w-full h-full object-cover opacity-60">
    
        <!-- Overlay with black background and text/button content -->
        <div class="absolute top-0 left-0 w-full h-full bg-black bg-opacity-50 flex flex-col items-center justify-center text-white">
            <!-- Text -->
            <h1 class="  mb-4 text-xl  lg:text-4xl">You're Not Alone, Let's Talk</h1>
            <!-- Buttons -->
            <div>
                <a href="#appointment" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 transition duration-300">Book An Appointment</a>
    ...
    <div class="w-full mx-auto px-2 py-2 lg:flex lg:justify-between ">
        <!-- Vision Section -->
        <div class="mb-4 lg:flex-1">
          <div class="bg-white shadow-md rounded-lg p-6 flex items-center h-full">
            ...
            <div>
              ...
              <p class="text-gray-600">
                To be a Centre of excellence in the provision of mental health services, accessible to all Malawians—men, women, boys, and girls.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="mb-4 lg:flex-1">
          <div class="bg-white shadow-md rounded-lg p-6 flex items-center h-full">
            ...
            <div>
              ...
              <p class="text-gray-600">
                To provide comprehensive and equitable mental health services for the well-being of all Malawians—men, women, boys, and girls.
              </p>
            </div>
          </div>
        </div>
      
        <!-- 24/7 Support and Services Section -->
        <div class="mb-4 lg:flex-1">
          <div class="bg-white shadow-md rounded-lg p-6 flex items-center h-full">
            <div class="text-orange-500 text-4xl mr-4">
              <i class="fas fa-phone-alt"></i>
            </div>
            <div>
              <h3 class="font-semibold text-lg">24/7 Support & Services</h3>
              <p class="text-gray-600">
                Access professional help and resources at any time, 24 hours a day, 7 days a week. We are committed to providing uninterrupted support, ensuring help is just a call away.
              </p>
            </div>
          </div>
        </div>
      </div>
      <!--<div class="w-full px-10 py-12 lg:flex lg:items-center lg:justify-between bg-blue-700 text-white text-center ">
        
         <div class="lg:w-1/2  flex justify-center">
            <img src="{{ asset('images/hospital.jpeg') }}" alt="Mental Health Care" class="w-full max-w-lg h-auto max-h-72 object-cover rounded-lg shadow-lg">
          </div>
        
        <div class="lg:w-1/2 mb-8 lg:mb-0 ">
          <h2 class="text-2xl font-semibold mb-4">Best Mental Care For Yourself and Your Family</h2>
          <p class="text-white mb-4">
            At Zomba Mental Hospital, we are dedicated to providing exceptional care for you and your loved ones. Our commitment to excellence is reflected in every aspect of our services, from our well-organized administration and skilled nursing staff to our experienced clinicians and attentive maintenance team. We also offer specialized occupational therapy to support your journey to recovery, ensuring that our patients' well-being is our top priority.
          </p>
          <p class="text-white mb-4">
            Our hospital also offers premium paying services for those seeking a more personalized experience. As a fully equipped medical facility, we provide the same level of medical assistance you would expect from any leading hospital in Malawi, including access to essential medications and treatments.
          </p>
          <p class="text-white">
            At Zomba Mental Hospital, your mental health is our mission. Let us help you achieve the best possible care for you and your family.
          </p>
        </div>
      ...
      <div class="w-full px-10 py-12 lg:flex lg:items-center lg:justify-between bg-blue-700 text-white text-center">
        ...
        <div class="lg:w-1/2 mb-8 lg:mb-0">
          ...
          <!-- Icons Section -->
          <div class="grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-4 pt-6">
            <div class="bg-light text-center rounded-full py-4 px-6">
              <i class="fa fa-3x fa-user-md text-primary mb-3"></i>
              <h6 class="mb-0">Qualified Clinicians & Nurses</h6>
            </div>
            <div class="bg-light text-center rounded-full py-4 px-6">
              <i class="fa fa-3x fa-procedures text-primary mb-3"></i>
              <h6 class="mb-0">Good Care</h6>
            </div>
            <div class="bg-light text-center rounded-full py-4 px-6">
              <i class="fa fa-3x fa-microscope text-primary mb-3"></i>
              <h6 class="mb-0">All Health Services</h6>
            </div>
            <div class="bg-light text-center rounded-full py-4 px-6">
              <i class="fa fa-3x fa-ambulance text-primary mb-3"></i>
              <h6 class="mb-0">Ambulance Services</h6>
            </div>
          </div>
        </div>
      </div>
      <section class=" bg-gray-200 py-12 px-6">
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <!-- Left Side: Text and Buttons -->
          <div>
            <h2 class="text-blue-600 font-bold uppercase tracking-wide  text-4xl text-center">
              Appointments
            </h2>
            <h1 class="mt-2  text-3xl font-semibold text-gray-800 leading-snug text-center">
              Make An Appointment <br />For You or Your Family
            </h1>
            <p class="mt-4 text-lg text-gray-600 leading-relaxed text-center">
              Taking care of your mental health is an important step towards overall
              well-being. At Zomba Mental Hospital, we believe mental health is a
              universal right, and we are here to support you. Whether you’re seeking
              counseling or occupational therapy, our compassionate team is ready to
              help.
            </p>
            ...
            <form>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    id="department"
                    class="mt-2 w-full p-3 border rounded-lg focus:ring-blue-500 focus:border-blue-500"
                    required
                  >
                    <option>Occup. Therapy Depart</option>
                    <option>Mental Counseling</option>
                    <option>Psychiatry</option>
                  </select>
                </div>
                <div>
                  <label for="doctor" class="block text-sm font-medium text-gray-600">
                    Select Doctor
                  </label>
                  <select
                    id="doctor"
              ...
              <div class="mt-8">
                <button
                  type="submit"
                  class="w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition duration-300 shadow-lg"
                >
                  Make An Appointment
                </button>
              </div>
      ...
      <section class="bg-white py-16 px-6">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="text-center">
            <h2 class="text-blue-600 font-semibold uppercase tracking-wide  text-4xl ">
              Our Blog
            </h2>
            <h1 class="mt-2  font-bold text-gray-800 text-2xl">
              Latest Articles & Updates
            </h1>
            <p class="mt-4 text-lg text-gray-600">
              Stay updated with the latest news, mental health tips, and stories from our hospital. Empowering you with knowledge for a healthier mind.
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-12">
            ...
            <div class="bg-gray-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div class="p-6">
                ...
                <p class="text-gray-600 mt-4">
                  Discover practical steps to boost your mental health, from mindfulness practices to maintaining a balanced lifestyle.
                </p>
                <div class="mt-4 flex items-center justify-between text-gray-500 text-sm">
                  <span>By Dr. Jane Doe</span>
            ...
            <div class="bg-gray-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div class="p-6">
                ...
                <p class="text-gray-600 mt-4">
                  Anxiety affects millions worldwide. Learn how to recognize symptoms and explore strategies to manage it effectively.
                </p>
                <div class="mt-4 flex items-center justify-between text-gray-500 text-sm">
                  <span>By Dr. John Smith</span>
            ...
            <div class="bg-gray-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-800">
                  <a href="#" class="hover:text-blue-600">
                    The Role of Family in Mental Wellness
                  </a>
                </h3>
                <p class="text-gray-600 mt-4">
                  A strong family support system can play a vital role in mental health recovery. Here's how families can help.
                </p>
                <div class="mt-4 flex items-center justify-between text-gray-500 text-sm">
                  <span>By Dr. Emily White</span>
          ...
          <div class="text-center mt-12">
            <a
              href="#"
              class="bg-blue-600 text-white px-8 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-lg"
            >
              View All Articles
            </a>
          </div>
